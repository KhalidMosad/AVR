...
void main()
{
	...
	while(1)
	{
		...
		I_RH=DHT11_U8Receive();	/* store first eight bit in I_RH */
		D_RH=DHT11_U8Receive();	/* store next eight bit in D_RH */
		I_Temp=DHT11_U8Receive();	/* store next eight bit in I_Temp */
		D_Temp=DHT11_U8Receive();	/* store next eight bit in D_Temp */
		CheckSum=DHT11_U8Receive();/* store next eight bit in CheckSum */
